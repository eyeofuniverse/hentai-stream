...
export const TAG_DICTIONARY: TagDef[] = [
  ...
  { name: "Group", category: "FETISH", synonyms: ["orgy", "gangbang", "gang bang", "group sex", "groupsex", "threesome", "foursome", "multiple partners", "train them", "spitroast", "double team"], landing: true },
