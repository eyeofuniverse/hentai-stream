...
export default function Statement2257() {
  return (
    <>
      ...
      <p>
        All characters depicted are fictional and are intended to be, and are
        represented as, adults aged 18 or older. Content that a moderator judges
        to depict an apparent minor in a sexual context is removed.
      </p>
      <h2>Reporting</h2>
      <p>
