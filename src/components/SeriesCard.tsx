    ...
    >
      ...
      >
        ...
        {series.externalScore ? (
          <span className="absolute right-2 top-2 flex items-center gap-0.5 rounded-md bg-black/60 px-1.5 py-0.5 text-[10px] font-bold text-warn backdrop-blur-sm">
          ...
          <span className="absolute right-2 top-2 rounded-md bg-good/85 px-1.5 py-0.5 text-[10px] font-bold text-black backdrop-blur-sm">
            UNC
          </span>
        ) : null}
        {eps > 0 && (
